...
md`<p>參考 作業六 <a href="https://observablehq.com/d/3b039b075022c35e">助教的notebook</a></p>`
)}
...
function _18(Plot,artist_columnKey,data,selectedSeries){return(
Plot.plot({
  height: 500,
  width: 600,
...
md`<h2>Strong baseline (陰影效果 & 滑鼠游標偵測效果)<h2>`
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Plot","artist_columnKey","data","selectedSeries"], _18);
