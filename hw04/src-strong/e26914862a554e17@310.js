...
await FileAttachment("no@2.svg").url()
)}
...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>填此問卷的藝術工作者的工作地點大多在"北部"和"南部"</li><br>
    <li>大多數藝術工作者"以行動或計畫進行"的方式來推動永續事務</li><br>
    <li>所以可以從上面兩點看出大多的藝術工作者都有在推動永續事務</li>
  </ul>
</h3>`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ...
    ["no@2.svg", {url: new URL("./no.svg", import.meta.url), mimeType: "image/svg+xml", toString}]
  ]);
