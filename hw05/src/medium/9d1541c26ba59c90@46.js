...
function _medium1(d3,medium_data,drag,invalidation)
{
  ...
  // 計算圖形並啟動力模擬。
  const root = d3.hierarchy(medium_data);
...
function _medium_data(FileAttachment){return(
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("medium1")).define("medium1", ["d3","medium_data","drag","invalidation"], _medium1);
  main.variable(observer()).define(["md"], _4);
  main.variable(observer("medium2")).define("medium2", ["d3","medium_data","drag","invalidation"], _medium2);
  main.variable(observer()).define(["md"], _6);
  main.variable(observer("medium3")).define("medium3", ["d3","medium_data","drag","invalidation"], _medium3);
  main.variable(observer("medium_data")).define("medium_data", ["FileAttachment"], _medium_data);
