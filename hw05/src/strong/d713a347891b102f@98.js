...
function _strong_all_data(FileAttachment){return(
FileAttachment("data.json").json()
)}

function _strong_data(FileAttachment){return(
FileAttachment("dataGroup.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ...
    ["dataGroup.json", {url: new URL("../dataGroup.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("strong")).define("strong", ["d3","strong_data","drag","url_list","invalidation"], _strong);
  main.variable(observer("strong_all_data")).define("strong_all_data", ["FileAttachment"], _strong_all_data);
  main.variable(observer("strong_data")).define("strong_data", ["FileAttachment"], _strong_data);
